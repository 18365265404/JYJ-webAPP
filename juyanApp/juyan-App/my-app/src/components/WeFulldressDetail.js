...
import '../assets/css/weFulldressDetail.css';
...
export default class WeFulldressDetail extends Component{
    ...
    constructor(props){
        ...
        this.state= {
            prevData:{
                ...
                identifying:querystring.parse(props.location.search).identifying,
...
<div>
    ...
    return (
        <div className="weFulldressDetail">
            <div style={{ height:'0rem'}}>

            </div>
            <div style={{ flex: '1',overflowY:"auto"}}>
            <div className="weFulldressDetail-head" style={{backgroundImage: `url(${this.state.prevData.qiniu+this.state.prevData.imgUrl})`}}>
                <p className="public-back" onClick={()=>{history.go(-1)}}>
                    <img src={"../assets/img/icon_back.png"}/>
                </p>
                <div className="weFulldressDetail-content">
                    ...
                    <p className="weFulldressDetail-content-p1">
                    ...
                    <p className="weFulldressDetail-content-p1">
                        地址：{this.state.prevData.address}
                    </p>
            ...
            <div className="weFulldressDetail-intr">
                <Tabs tabs={tabs}
                initialPage={0}
                swipeable={false}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',width: '9.25rem' ,overflow: 'hidden'}}>
                    <ul className="weFulldressDetail-intr1">
