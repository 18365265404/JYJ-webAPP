...
import '../assets/css/weFlowerDetail.css';
...
export default class WeFlowerDetail extends Component{
    ...
    constructor(props){
        ...
        this.state= {
            prevData:{
                ...
                classify:querystring.parse(props.location.search).classify,
                describe:querystring.parse(props.location.search).describe,
                starLevel:querystring.parse(props.location.search).starLevel,
                style:querystring.parse(props.location.search).style,
                prices:querystring.parse(props.location.search).prices,
...
<div>
    ...
    return (
        <div className="weFlowerDetail">
            <div style={{ height:'0rem'}}>

            </div>
            <div style={{ flex: '1',overflowY:"auto"}}>
            <div className="weFlowerDetail-head" style={{backgroundImage: `url(${this.state.prevData.qiniu+this.state.prevData.imgUrl})`}}>
                <p className="public-back2" onClick={()=>{history.go(-1)}}>
                    <img src={"../assets/img/icon_back.png"} style={{width:"0.6rem",height:"0.4rem"}}/>
                </p>
                <div className="weFlowerDetail-content">
                    ...
                    <p className="weFlowerDetail-content-p1">
                        作品分类：{this.state.prevData.classify}
                    </p>
                    <p style={{display:"none"}} className="weFlowerDetail-content-p1">
                        所在城市：{this.state.prevData.city}
                    </p>
                    <p className="weFlowerDetail-content-p1">
                        作品风格：{this.state.prevData.style}
                    </p>
                    <p className="weFlowerDetail-content-p1">
                        参考价格：{this.state.prevData.prices}
                    </p>
            ...
            <div className="weFlowerDetail-intr">
                <Tabs tabs={tabs}
                initialPage={0}
                swipeable={false}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',width: '9.25rem' ,overflow: 'hidden'}}>
                    <ul className="weFlowerDetail-intr1">
