...
import '../assets/css/weFlower.css';
...
export default class WeFlower extends Component{
  ...
  goSearch(value){
    ...
    postRequestNocity(url.waaWAfindAllWedding, {
        weddingName : value ? value :"",
...
window.addEventListener('scroll', function () {
    ...
    loadMoreDataFn(that) {
      ...
      postRequestNocity(url.waaWAfindAllWedding, {
        weddingName : this.state.searchValue ? this.state.searchValue :"",
        city:this.state.city ? this.state.city : "",
        prices:this.state.prices ? this.state.prices : "",
  ...
  render(){
    ...
    function handleChange(kind,value) {
      ...
      return(
        <div className="weFlower" style={{display:"flex",flexDirection:"column"}}>
          ...
          <div style={{margin:" -0.2rem 0",marginBottom:"-0.5rem"}}>
                  ...
                  <Search
                     ...
                     />   
                       ...
                       {/* 选择框 */}
          <div style={{}} className="ThemeList-search">
          <Select
            className="ThemeList-search1"
            showSearch
            style={{ width: "45%",marginLeft:"3%",display:"none"}}
            placeholder="区/县"
          ...
          <Select
            ...
            <div className="weFlower-content-list" >
              ...
              {/* 列表 */}
              <ul className="weFlower-list">

                {
                  this.state.list.map((item,index)=>{
                      return(
                        <li key={item.id}>
                        <Link to={"/WeFlowerDetail/"+item.id
                        +"?title="+item.weddingName
