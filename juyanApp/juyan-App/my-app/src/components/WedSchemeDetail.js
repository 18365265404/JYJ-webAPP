...
import '../assets/css/wedSchemeDetail.css';
...
export default class WedSchemeDetail extends Component{
...
/************ 上面是表单提交***************** */  
 ...
 <div>
    ...
    return (
        <div className="wedSchemeDetail">
            <div style={{ height:'0rem'}}>

            </div>
            <div style={{ flex: '1',overflowY:"auto"}}>
            <div className="wedSchemeDetail-head" style={{backgroundImage: `url(${this.state.prevData.qiniu+this.state.prevData.imgUrl})`}}>
                <p className="public-back2" onClick={()=>{history.go(-1)}}>
                    <img src={"../assets/img/icon_back.png"} style={{width:"0.6rem",height:"0.4rem"}}/>
                </p>
                <div className="wedSchemeDetail-content">
                    ...
                    <p className="wedSchemeDetail-content-p1">
            ...
            <div className="wedSchemeDetail-intr">
                <Tabs tabs={tabs}
                initialPage={0}
                swipeable={false}
