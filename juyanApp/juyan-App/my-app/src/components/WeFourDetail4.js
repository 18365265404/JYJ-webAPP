...
import '../assets/css/weFourDetail4.css';
...
export default class WeFourDetail4 extends Component{
        ...
        <div className="weFourDetail1">
            ...
            <div className="weFourDetail1-head" style={{backgroundImage: `url(${this.state.prevData.qiniu+this.state.prevData.imgUrl})`}}>
                ...
                <div className="weFourDetail1-content">
                    ...
                    <p className="weFourDetail1-content-p1">
                        摄像介绍：{this.state.prevData.content2}
                    </p>
                    ...
                    <ul className="weFourDetail1-intr1">
                        
                          {
                            this.state.detailList.map((item,index)=>{
                                return (
                                    <li key={item.id}>
                                     <video style={{width:"9rem",height:"5rem",marginLeft:"0.2rem"}} src={this.state.prevData.qiniu+item.pictureKey} controls="controls">
                                            您的浏览器不支持 video 标签。
                                     </video>
